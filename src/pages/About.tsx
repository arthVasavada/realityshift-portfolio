...
const About: React.FC = () => {
  return (
    <section
      id="about"
      className="h-screen-minus-navbar pt-16 bg-gray-800 text-white flex justify-center items-center gap-8"
    >
      {/* Image Animation */}
      <motion.div
        layoutId="profile-image"
        className="w-80 h-80 rounded-full overflow-hidden border-2 border-teal-400 shadow-lg cursor-pointer"
      ...
      >
        <h1 className="text-3xl font-extralight mb-4 text-teal-400">
          About Me
        </h1>
